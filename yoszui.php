...
<head>
    ...
    <link rel="stylesheet" href="assets/yoszui.css">
    <link rel="icon" type="image/png" sizes="96x96" href="images/favicon-96x96.png">
    <title>Ёс зүйн дэд хороо | Хяналт шалгалтын газар</title>
</head>
    ...
    <section id="yoszui">
        <div class="container">
            <div class="subcontainer">
                <div class="pos-intro">
                    <div>
                        <h3>Төрийн албан хаагчийн ёс зүйн зарчим</h3>
                        <span>2025-05-11</span>


                        <div class="pos-pdf">
                            <iframe id="pdf" src="include/yoszui/Зассан-Ёс зүйн хэм хэмжээ.pdf#view=FitH&navpanes=0&toolbar=0"></iframe>
                        </div>
                    </div>

...
if (isset($_GET['id'])) {
    $p = selectOne('plan', ['id' => $_GET['id']]);
}
$other_p = selectAll('plan' . " ORDER BY id DESC LIMIT 10");
...
<body>
    ...
    <section id="dynamic-plan">
        <div class="container">
            <div class="subcontainer">            
                <div class="plan-one">       
                    <h3><?php echo $p['title']; ?></h3>
                    <span class="date"><?php echo $p['date']; ?></span><br>
                    <div class="pdf-wrapper">
                        <iframe id="pdf" src="include/plan/<?php echo $p['file_path']; ?>#view=FitH&navpanes=0&toolbar=0" frameborder="0"></iframe> 
                    </div>                
                </div>
                <hr>
                <div class="other-plan">
                    <?php foreach($other_p as $p): ?>
                        <a href="plan-one?id=<?php echo $p['id']; ?>">
                            <div class="other-card">
                                <div class="other-post-content">
                                    <h3 class="op-title2" ><?php echo $p['title']; ?></h3>
                                </div>
                            </div>
                        </a>
                    <?php endforeach; ?> 

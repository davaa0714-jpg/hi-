...
$tog_biyelelt2025 = selectOne('togtoolbiyelelt', ['season' => "3"]);
$tog_biyelelt2024 = selectOne('togtoolbiyelelt', ['season' => "2"]);
$tog_biyelelt2023 = selectOne('togtoolbiyelelt', ['season' => "1"]);
    ...
    <section id="togtool-biyelelt">
        <div class="container">
            <div class="filter-container">
                <div class="filter-item third" data-filter="tog-biyelelt3"><span>2025</span></div>
                <div class="filter-item second" data-filter="tog-biyelelt2"><span>2024</span></div>
                <div class="filter-item first" data-filter="tog-biyelelt1"><span>2023</span></div>
            </div>
            <br>
            <div class="subcontainer">
                <div class="tog-biyelelt3 biyelelt-wrapper">
                    <div class="biyelelt-pdf">
                        <iframe id="pdf" src="include/togtool_biyelelt/<?php echo $tog_biyelelt2025['path']; ?>#view=FitH&navpanes=0&toolbar=0" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="tog-biyelelt2 biyelelt-wrapper">
                    <div class="biyelelt-pdf">
                        <iframe id="pdf" src="include/togtool_biyelelt/<?php echo $tog_biyelelt2024['path']; ?>#view=FitH&navpanes=0&toolbar=0" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="tog-biyelelt1 biyelelt-wrapper">
                    <div class="biyelelt-pdf">
                        <iframe id="pdf" src="include/togtool_biyelelt/<?php echo $tog_biyelelt2023['path']; ?>#view=FitH&navpanes=0&toolbar=0" frameborder="0"></iframe>
                    </div>
                </div>
            </div>
        </div>

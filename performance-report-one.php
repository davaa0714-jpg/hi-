    ...
    <section id="dynamic-att">
        <div class="container">
            <div class="subcontainer">
                <div class="att-one">
                    <h3> <?php echo $performance['Department']; ?>
                        <span>
                            <?php
                            echo $performance['Year'] . ' ';
                            if (!empty($performance['IsHalf']) && $performance['IsHalf'] == 1) {
                                echo "Эхний хагас жил";
                            } else {
                                echo "Жилийн эцэс";
                            }
                            ?>
                    ...
                    <div class="pdf-wrapper">
                        <iframe id="pdf" src="include/performance/<?php echo $performance['pdf']; ?>#view=FitH&navpanes=0&toolbar=0" frameborder="0"></iframe>
                    </div>
                </div>
            </div>
        </div>
